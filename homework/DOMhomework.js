...
span.innerHTML += " Pablo Szejpiacki";
...
function buildToDo(todo, index) {
  ...
  todo.complete ? label.className = "completeText" : label.className = "";
...
function buildToDos(toDos) {
  // Tu código acá:
  let todos = toDos.map(function(element, index) {
...
// Tu código acá:
  ...
  document.querySelector("#addButton").addEventListener("click", addToDo, false);
